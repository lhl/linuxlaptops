 ...
 *
 * Disassembly of dsdt.dat, Sun Aug 20 10:13:57 2023
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00006375 (25461)
 *     Revision         0x02
 *     Checksum         0xCF
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0x9178B000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0x9178F000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD310510)
    Name (FTPM, 0xFD310510)
    Name (PPIM, 0x96891F18)
    Name (PPIL, 0x1C)
    Name (TPMF, One)
    Name (PPIV, One)
    Name (AMDT, 0x01)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0x9687ED18, 0x0D)
        ...
        Device (RHUB)
        {
            ...
            Device (PRT1)
            {
                ...
                Device (PRT1)
                {
                    ...
                    {
                        Return (M601 (0x02, One, One, 0x03, 0x0113, Zero))
                    }
                }
            ...
            Device (PRT2)
            {
                ...
                Device (PRT1)
                {
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Return (M601 (0x02, One, One, 0x03, 0x0114, Zero))
                    }
                }
                ...
                Device (PRT2)
                {
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        Return (M601 (0x02, One, 0x02, 0x03, 0x0114, Zero))
                    }
                }
            }
